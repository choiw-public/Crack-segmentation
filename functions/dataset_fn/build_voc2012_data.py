...
tf.app.flags.DEFINE_string("image_folder",
                           "/media/wooram/DATA/00.Research/Image_dataset/VOC/2012/VOCdevkit2012/VOC2012/JPEGImages",
                           "Folder containing images.")

tf.app.flags.DEFINE_string(
    "semantic_segmentation_folder",
    "/media/wooram/DATA/00.Research/Image_dataset/VOC/2012/VOCdevkit2012/VOC2012/SegmentationClass",
    "Folder containing semantic segmentation annotations.")

tf.app.flags.DEFINE_string(
    "list_folder",
    "/media/wooram/DATA/00.Research/Image_dataset/VOC/2012/VOCdevkit2012/VOC2012/ImageSets/Segmentation",
    "Folder containing lists for training and validation")

tf.app.flags.DEFINE_string(
    "output_dir",
    "/media/wooram/DATA/00.DL_Python/00.Wooram/datasets/delete",
  ...
  for shard_id in range(_NUM_SHARDS):
    ...
    with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
      ...
      for i in range(start_idx, end_idx):
        ...
        example = build_data.image_n_seg_to_tfexample(
