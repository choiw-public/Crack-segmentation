...
# goprodataset
# tf_blur = "/media/wooram/DATA/00.DL_datasets/GOPRO_dataset_for_deblur/restructured/_train_phase/images/tf_blur" # for tf_blur
# tf_blur = "/media/wooram/DATA/00.DL_datasets/GOPRO_dataset_for_deblur/restructured/_train_phase/images/blur_gamma" # for blur_gamma
blur_dir = "/media/wooram/DATA/00.DL_datasets/GOPRO_dataset_for_deblur/restructured/_train_phase/images/blur_gamma"
sharp_dir = "/media/wooram/DATA/00.DL_datasets/GOPRO_dataset_for_deblur/restructured/_train_phase/images/sharp"
out_folder = "/media/wooram/DATA/00.DL_datasets/GOPRO_dataset_for_deblur/restructured/_train_phase"
