...
def subpxlup(tensor, factor):
    return SubpixelConv2D(factor)(tensor)
    ...
    def build(main_pipe):
        with tf.variable_scope(scope):
            with tf.variable_scope('context'):
                ...
                "<tf.Variable 'fp32_var/cyc1_encoder2/denconv/invdenconv03/pw_conv/gc_block/context/kernel:0' shape=(1, 1, 32, 1) dtype=float32>"
